...
function setup() {
	...
	rectangle2Sprite=createSprite(500,640,10,60)
	rectangle2Sprite.shapeColor=color("red")

	rectangle3Sprite=createSprite(400,665,200,10)
    rectangle3Sprite.shapeColor=color("red")

    rectangleSprite=createSprite(300,640,10,60)
    rectangleSprite.shapeColor=color("red")
